...
<div id="userPage" class="container bodyContentMarginTop">

    <div class="col-md-12">
        <!-- <div class="row"> -->
       <?php global $user;
        if($user->uid || arg(1) == 'password' || drupal_get_title() == 'Reset password') {
        //if (is_numeric(arg(1)) && arg(0) == "user" && $user->uid == arg(1) || arg(1) == 'reset') { ?>
 
 <div id="usercontent" class="span-17 last">
	 ...
	 <?php print render($page['content']); ?>
       ...
       <div class="row">
          <div class="col-md-6">
             <h1 class="bigText"> • sign in • </h1>
             <p>ALREADY HAVE AN ACCOUNT? SIGN IN BELOW</p>
              <?php  print(drupal_render(drupal_get_form('user_login_block'))); ?>
          </div>
          <div class="col-md-6">
              <h1 class="bigText"> • register • </h1>
              <p>NEED TO CREATE AN ACCOUNT? USE THE FORM BELOW TO REGISTER. CREATING AN ACCOUNT WILL MAKE ONLINE ORDERING EASIER AND WILL HELP YOU TO KEEP IN TOUCH WITH ZAZEN BEAR</p>
              <?php //print $form; ?> 
...
?>
<script type="text/javascript" src="/sites/all/themes/zazenbear/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="/sites/all/themes/zazenbear/js/additional-methods.min.js"></script>