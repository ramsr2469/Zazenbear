...
<div id="wrapperMarqueeGift" class="bodyContentMarginTop">
    <div class="container">
        <div class="col-md-6 col-md-offset-3">
            <h1 class="bigText">  • GIFTS • </h1>
            <p class="marqueeGift">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
<!--            <p class="btnDefault">-->
...
<!--    <div class="container">-->
<!--        <div class="col-md-12">-->
<!--            --><?php //print render($page['giftTitles']); ?>
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
...
<div id="everydayMoments" class="container">
    ...
    <div class="row">
        <?php print render($page['featuredgift']); ?>
    </div>
</div>
