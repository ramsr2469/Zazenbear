...
<div class="bodyContentMarginTop">
    <?php print render($page['categorylandingtitle']); ?>
</div>
...
<div id="everydayMoments" class="container">
    ...
    <div class="row">
        <?php print render($page['categoryfeaturedproducts']); ?>
    </div>
</div>


<div id="wrapperFooterJewelry">
    <?php print render($page['featuredCollectionFooter']); ?>
    <div id="rightFooterJewelry" class="col-sm-6">
        <div id="rightFooterJewelry-1" class="col-md-5 col-md-offset-1">
            <?php print render($page['featuredCollectionFooterRight1']); ?>
        </div>
        <div id="rightFooterJewelry-2" class="col-md-5">
            <?php print render($page['featuredCollectionFooterRight2']); ?>
        </div>
    </div>
</div>
