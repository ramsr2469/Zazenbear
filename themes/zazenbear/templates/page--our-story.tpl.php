...
<!-- end mobile navigation -->
    ...
    <div class="bodyContentMarginTop">
        <?php print render($page['ourStoryBanner']);?>
        <?php print render($page['content']);?>
    </div>

   <div class="wrapperBigFooter">
    <div class="col-sm-12 col-md-6 wrapperBigFooterLeft">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <h1 class="bigTitle">need help?</h1>

                <p>Get information on purchasing our products, shipping returns and more.</p>

                <p class="btnDefault">
                    <a class="btn btn-lg btn-default videoPlayer" href="/customer-support">CUSTOMER SUPPORT</a>
                </p>
            </div>
        </div>
    </div>

    <div class="col-sm-12 col-md-6 wrapperBigFooterRight">
        <h1 class="bigTitle">in the news</h1>
        <?php print render($page['news']);?>
        <p class="btnDefault">
            <a class="btn btn-lg btn-default videoPlayer" href="/news">MORE NEWS</a>
        </p>
    </div>
</div>
<!-- footer -->
