...
<div id="wrapperPuzzleShopPage" class="bodyContentMarginTop">
    
    <?php print render($page['content']);?>
</div>
<!-- end puzzel shop page -->

<div id="zazenBaerFeaturing">
    <div class="container ">
        <div class="row">
            <div class="col-sm-12 ">
                <h1 class="dot"> featuring </h1>
            </div>
        </div>
...
<div id="wrapperFooterShop">
    <div id="leftFooterShop" class="col-sm-6">
        <h1 class="bigText">visit our store</h1>
        <p>Come by and visit us at our new flagship store in SOHO!</p>
        <p class="btnDefault">
            <a class="btn btn-lg btn-default videoPlayer" href="/visit">LEARN MORE</a>
        </p>
    </div>
    <div id="rightFooterShop" class="col-sm-6">
