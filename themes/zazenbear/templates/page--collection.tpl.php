...
<!-- end mobile navigation -->
 <div class="breadcrumbWrapper">
        ...
        <div id ="featuredcollection" class="bodyContentMarginTop">
             
            <?php print render($page['featuredcollection']); ?>   
        </div><!--end of featuredcollection-->
        <div id="collectioncategories">
           <?php print render($page['collectioncategories']); ?> 
        </div><!--end of collectioncategories-->
        <div id="collectionCcontent">
