<?php
    ...
    $pageURL = zazenbear_get_pagePath();
    $pageLinks = zazenbear_get_domainPath().''.$base_path.'';
?>
...
<!-- end mobile navigation -->  
    ...
    <?php
        if (!(strstr($pageURL,'/jewelery-list')||strstr($pageURL,'/gift-list')||strstr($pageURL,'/home-list')||strstr($pageURL,'/fashion-list'))){ ?>
        <div id="bannerStaticPage" class="bodyContentMarginTop">

            <div class="container">
                <h1 class="bigText"> • <?php print $title; ?> • </h1>
            </div>
        </div>
    <?php } ?>
